...
<head>
    ...
    while ($row = $resultarr[$i]) {
        ...
        $spitznamen = array("Khalin", "Janni", "Timouw", "Le Nerd", "TT", "Paul Klotzke", "LX");
        $klarnamen = array("Collin", "Jan-Simon", "Timow", "Lennart", "Theresa", "Paul", "Henry");
    ...
    <script type="text/javascript">
        ...
        const reverseGeocodeStickers = async () => {
            //TODO sticker Koordinaten einfuegen
            const stickerCoords = getStickerCoords();
            for (const [name, coords] of Object.entries(stickerCoords)) {
                const url = 'https://nominatim.openstreetmap.org/reverse?format=jsonv2&email=malte.now@gmx.de&zoom=14&lat=' + coords[0] + '&lon=' + coords[1];
...
<div id="barchart_material"
     style="width: 90vw; max-width: 900px; height: 1500px; margin-top: -15vh; margin-left: 10vw;"></div>
